...
const images = [imgDani, imgNacho, imgVale, imgMateo, imgSanti];
const info = [
  {
  ...
  return (
    <>
      ...
      <main className="about">
        ...
        >
          <GrFormPrevious className="buttonPrev" />
        </button>
        <div className="about-card">
          <div className="about-images">
            <img alt="hola" className="img-about" src={images[index]} />
          </div>
        ...
        >
          <GrFormNext className="buttonNext" />
        </button>
      </main>
      <Footer />
    </>
